...
export default function SongPlayer() {
    ...
    return (
        <main className='mx-auto max-w-lg h-screen'>
            ...
            <div className='pt-16'>
                <img className='' src={song.album.images[0].url} alt={song.name} />

                <section className='pt-14 bottom-0 mx-auto'>
                    <div className='mx-auto'>
                        <h1 className='text-center font-bold text-xl'>{song.name}</h1>
                        <p className='text-center text-sm py-2'>{song.artists.map(artist => artist.name).join(', ')}</p>
                    </div>
                    ...
                    <div className='mx-auto grid grid-cols-5 gap-2 justify-center max-w-72 pt-2'>
